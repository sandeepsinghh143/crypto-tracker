...
export default function CoinInfo({coin}) {
    ...
    const shortDesc= coin.desc.slice(0,350) +"<div style='color:var(--grey)'>Read More...</div>";
    const longDesc = coin.desc+"<div style='color:var(--grey)'>Read Less...</div>";
  return (
    <div className='bg-[var(--darkgrey)] p-6 mt-4 rounded-[1rem]' onClick={()=>setFlag(!flag)}>
